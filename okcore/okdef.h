...
**      15-03-27    / 4.1.0     / K L   / Added OK4 Capabilities                        **
**      15-06-23    / 4.2.0     / K L   / Added more OK4 Capabilities                   **
**											**
*****************************************************************************************/

#ifndef	__OKDEF_H_INCLUDED__
#define	__OKDEF_H_INCLUDED__
...
#define SLOT_OK4_CAPABILITIES	0x13	/* Read OK4 capabilities (device info) list */
#define SLOT_OK4_SET_DEVICE_INFO 0x15 /* Write device info */
...
#define	OK4_OTP_PID		0x0401	/* Yubikey 4 - OTP only */
#define	OK4_U2F_PID		0x0402	/* Yubikey 4 - U2F only */
#define	OK4_OTP_U2F_PID		0x0403	/* Yubikey 4 - OTP and U2F */
#define	OK4_CCID_PID		0x0404	/* Yubikey 4 - CCID only */
#define	OK4_OTP_CCID_PID	0x0405	/* Yubikey 4 - OTP and CCID */
#define	OK4_U2F_CCID_PID	0x0406	/* Yubikey 4 - U2F and CCID */
#define	OK4_OTP_U2F_CCID_PID	0x0407	/* Yubikey 4 - OTP, U2F and CCID */

#define	PLUS_U2F_OTP_PID	0x0410	/* Yubikey plus - OTP+U2F */

#define OK4_CAPA_TAG		0x01	/* TAG for capabilities */
#define OK4_SERIAL_TAG		0x02	/* TAG for serial number */

#define OK4_CAPA1_OTP		0x01	/* Capability bit for OTP functonality */
#define OK4_CAPA1_U2F		0x02	/* Capability bit for U2F functionality */
#define OK4_CAPA1_CCID		0x04	/* Capability bit for CCID functionality */
#define OK4_CAPA1_OPGP		0x08	/* Capability bit for OpenPGP functionality */
#define OK4_CAPA1_PIV		0x10	/* Capability bit for PIV functionality */
#define OK4_CAPA1_OATH		0x20	/* Capability bit for OATH functionality */

#if defined(_WIN32) || defined(__GNUC__)
#pragma pack(pop)
#endif

#endif	/* __OKDEF_H_INCLUDED__ */
